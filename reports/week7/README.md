...
|---|---|---|---|---|
| scaredofthesix (Maksim Bodulev, Scrum Master) | **Designed and implemented the new Voice Maze Quest game** that replaced Magic Wizard (generated 5x5/7x7/9x9 labyrinths, spoken route choices, crystals, an avoidable red hazard, a locked portal, and endless random floors) - iterated from PR #158/#162 into the final Voice Maze Quest in PR #167 under #125. Also implemented all other Sprint 5 fix PRs #153-#158 and integration PR #160 for issues #140-#145, the remaining final MVP3 review fixes in PR #167 (5x5 default, editable invalid rows, readable route words, duplicate-recognition gate), and release-preparation PR #168 | Prepared #167 and #168 for independent review; #167 (including Voice Maze Quest) was reviewed and merged by TeraloToxin; #168 was approved by TeraloToxin | Wrote the Voice Maze Quest, adaptive, parser, and other game tests and ran the release quality gate | CHANGELOG, roadmap, Week 7 report, handover doc, public demo, v0.5.0 release orchestration |
