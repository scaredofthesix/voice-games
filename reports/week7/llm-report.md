...
- Week 7 rehearsal completion and the customer's final written confirmation are separate
  human evidence and are not inferred from code, tests, or the demo video. The customer's
  written acceptance was received on 2026-07-17 and is kept as private Moodle evidence; the
  status update was made by the team from that real reply, not generated by any LLM.
