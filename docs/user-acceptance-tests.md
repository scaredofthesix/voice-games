...
merged. The final `v0.5.0` SemVer release is published from protected `main`. After receiving
the release and live product links, the customer confirmed acceptance of MVP v3 v0.5.0 in
writing on 2026-07-17, completing the handover.
