...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState<'HUB' | 'VOICE_RACER' | 'BUBBLE_POPPER' | 'BOSS_FIGHT' | 'WORD_LADDER' | 'SKATE_WORD' | 'ASTE_WORD' | 'SENTENCE_BIRD' | 'ECHO_RECORDER' | 'PROGRESS'>('HUB');
  ...
  return (
    ...
    >
      ...
      {currentView !== 'BOSS_FIGHT' && currentView !== 'WORD_LADDER' && currentView !== 'SKATE_WORD' && currentView !== 'ASTE_WORD' && currentView !== 'SENTENCE_BIRD' && currentView !== 'ECHO_RECORDER' && currentView !== 'PROGRESS' && (
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full sm:w-auto justify-end">
                      ...
                      {g.unlocked ? (
                        <button
                          ...
                          aria-label={g.id === 'sentence-bird' ? 'play sentence bird' : g.id === 'echo-recorder' ? 'play echo microphone' : `${g.title} ${t('hub.playButton')}`}
