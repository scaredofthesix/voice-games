...
const UI_TEXT: Record<UiLanguage, TranslationDictionary> = {
  en: {
    ...
    wizard: {
      ...
      preview: {
        fire: { title: 'FIRE SPELLS', description: 'Cast blazing fireballs!' },
        ice: { title: 'ICE SPELLS', description: 'Freeze enemies with ice!' },
        lightning: { title: 'LIGHTNING SPELLS', description: 'Zap with electric lightning!' },
      },
    },
    sentenceBird: {
      title: 'Sentence Bird',
  ...
  ru: {
    ...
    wizard: {
      ...
      preview: {
        fire: { title: 'ОГНЕННЫЕ ЗАКЛИНАНИЯ', description: 'Мечи пылающие огненные шары!' },
        ice: { title: 'ЛЕДЯНЫЕ ЗАКЛИНАНИЯ', description: 'Замораживай врагов льдом!' },
        lightning: { title: 'ЗАКЛИНАНИЯ МОЛНИИ', description: 'Поражай врагов молнией!' },
      },
    },
    sentenceBird: {
      title: 'Фразоптичка',
